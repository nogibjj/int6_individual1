...
def test_create_viz():
    ...
    assert os.path.exists("resources/plot_tempo.png"), "The plot_tempo.png file does not exist."
    assert os.path.getsize("resources/plot.png") > 0, "The plot.png file is empty."
    assert os.path.getsize("resources/plot_tempo.png") > 0, "The plot_tempo.png file is empty."
    print("All assertions passed for test_create_viz.")


def test_generate_report():
    create_report(data_path)
    assert os.path.exists("spotify_report.pdf"), "The spotify_report.pdf file does not exist."
    assert os.path.getsize("spotify_report.pdf") > 0, "The spotify_report.pdf file is empty."
